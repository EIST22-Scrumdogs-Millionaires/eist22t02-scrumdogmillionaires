...
public class Util {
        ...
        public static String reservationMail(Visitor user, Reservation reservation){
                String mailText = "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                        ...
                        "            <p style=\"font-size: 14px; line-height: 170%;\"><span style=\"font-family: Raleway, sans-serif; font-size: 16px; line-height: 27.2px;\">Hallo \" + user.getUsername() + \",</span></p>\n" +
                        ...
                        "        <p style=\"font-size: 14px; line-height: 170%;\"><span style=\"font-family: Raleway, sans-serif; font-size: 16px; line-height: 27.2px;\">Sie haben bei \" + RestaurantOverview.getRestaurantById(reservation.getRestaurant_id()) + \" reserviert:</span></p>\n" +
                        "        <p style=\"font-size: 14px; line-height: 170%;\"><span style=\"font-family: Raleway, sans-serif; font-size: 16px; line-height: 27.2px;\">Tisch \" + reservation.getTable().getId() + \"&nbsp;am \" + reservation.getDate() + \" um \" + reservation.getTime() + \"<br />Reservierungsname: \" + reservation.getUser().getUsername() + \"<br />Best&auml;tigungsnummer: \" + reservation.getId() + \"</span></p>\n" +
                        "          </div>\n" +
                        "\n" +
                        "      </td>\n" +
                        "    </tr>\n" +
                        ...
                        "    F&uuml;gen Sie den Termin zu Ihrem Kalender hinzu: \" + EmailServiceImpl.generateCalendarLink(reservation, RestaurantOverview.getRestaurantById(reservation.getRestaurant_id())) + \"\n" +
                        "  </h1>\n" +
                        "\n" +
                        "      </td>\n" +
                        "    </tr>\n" +
                        ...
                        "    <a href=\"localhost:8080/reservations/&quot;                         + reservation.getId() + &quot;/&quot; + reservation.getCancelSecretKey()\" target=\"_blank\" class=\"v-size-width\" style=\"box-sizing: border-box;display: inline-block;font-family:arial,helvetica,sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #c5e1a5; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:46%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;border-top-color: #000000; border-top-style: solid; border-top-width: 0px; border-left-color: #000000; border-left-style: solid; border-left-width: 0px; border-right-color: #000000; border-right-style: solid; border-right-width: 0px; border-bottom-color: #000000; border-bottom-style: solid; border-bottom-width: 0px;\">\n" +
