...
public class Restaurant {
	...
	public boolean passReservation(Reservation reservation, Visitor user) {
		...
		Email email = new Email(user.getEmail(), "Bitte bestätigen Sie Ihre Reservierung", "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
				...
				"</body>\n" +
				"\n" +
				"</html>", LocalDate.now(), LocalTime.now());
		Email emailRes = new Email(user.getEmail(), "Reservierung bestätigt", emailResConfirmText, LocalDate.now(), LocalTime.now());
